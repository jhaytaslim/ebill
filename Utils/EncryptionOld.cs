...
{
    public static class AESThenHMAC2
    {
        ...
        public static byte[] NewKey()
        {
            ...
            Random.GetBytes(key);
            Console.WriteLine("key: " + Encoding.UTF8.GetString(key, 0, key.Length));
                           ...
                           byte[] nonSecretPayload = null)
        {
            ...
            var cipherText = SimpleEncrypt(plainText, cryptKey, authKey, iv, nonSecretPayload);
                           ...
                           int nonSecretPayloadLength = 0)
        {
            try
            {
                ...
                var cipherText = System.Text.Encoding.UTF8.GetBytes(encryptedMessage);
        ...
        public static byte[] SimpleEncrypt(byte[] secretMessage, byte[] cryptKey, byte[] authKey, byte[] iv, byte[] nonSecretPayload = null)
        {
            //User Error Checks
        ...
        public static byte[] SimpleDecrypt(byte[] encryptedMessage, byte[] cryptKey, byte[] authKey, int nonSecretPayloadLength = 0)
        {
            try
            {
                ...
                Console.WriteLine("crypt key: " + cryptKey.Length);
                if (cryptKey == null || cryptKey.Length != KeyBitSize / 8)
